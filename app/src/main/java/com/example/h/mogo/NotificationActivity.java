...
public class NotificationActivity extends Activity
{
    ...
    public void get_notification_feed(String grid_info){
        final RelativeLayout list_view = (RelativeLayout) findViewById(R.id.notification_wrapper);
            ...
            public void done(List<ParseObject> list, com.parse.ParseException e) {
                if (e == null) {
                    ...
                    for (ParseObject object : list) {
                        ...
                        String lat = Double.toString(((ParseGeoPoint) object.get("location")).getLatitude());
                        String lon = Double.toString(((ParseGeoPoint)object.get("location")).getLongitude());
                        data_item[2] = lat + "/" + lon;
